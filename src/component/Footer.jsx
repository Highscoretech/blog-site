        ...
        <div className="fotter-container">
            ...
            <div className="stay-connected">
                <div className="right">
                    ...
                    <a href="#">
                    <div class="social-item elementor-repeater-item-52281dd x-fab-fa-x-twitter"><div class="social-icon">
...
<a class="rivax-position-cover" href="#" title="" target="_blank" aria-label="Social Media"></a></div>
                    </a>
                    <a href="#">
                    <div class="social-item elementor-repeater-item-7aaaea8 x-fab-fa-whatsapp"><div class="social-icon">
